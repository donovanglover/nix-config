  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "${super}, C, layoutmsg, mfact exact 0.80"
        "${super}, C, layoutmsg, orientationtop"
        "${super}_SHIFT, C, layoutmsg, mfact exact 0.55"
        "${super}_SHIFT, C, layoutmsg, orientationleft"
        "${super}, H, layoutmsg, addmaster"
        "${super}, L, layoutmsg, removemaster"
        "${super}_SHIFT, H, layoutmsg, mfact -0.05"
        "${super}_SHIFT, L, layoutmsg, mfact +0.05"
      ...
      bindl = [
        ...
        ", XF86AudioRewind, exec, playerctl -p playerctld previous"
        ", XF86AudioForward, exec, playerctl -p playerctld next"
        ", XF86AudioPlay, exec, playerctl -p playerctld play"
        ", XF86AudioPause, exec, playerctl -p playerctld pause"
        ", XF86AudioNext, exec, playerctl -p playerctld position 10+"
        ", XF86AudioPrev, exec, playerctl -p playerctld position 10-"
      ];
